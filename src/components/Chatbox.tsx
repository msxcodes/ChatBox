...
function Chatbox() {
  return (
    <div className="border h-full w-full  bg-white ">
      <div className="flex-grow  h-full text-left text-gray-700">
        <div className="h-5/6 overflow-y-scroll px-8 pt-4 ">
        <div className="relative mb-6 text-center">
          <span className="relative rounded-xl px-3 text-sm text-gray-600">
            28 June, 2022
          </span>
        </div>
